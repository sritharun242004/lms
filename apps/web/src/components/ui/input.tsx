  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-primary/20 focus-visible:bg-white focus-visible:shadow-[0_8px_24px_rgba(30,64,175,.08)] focus-visible:ring-3 focus-visible:ring-ring/15",
